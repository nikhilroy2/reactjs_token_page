    ...
    <div>
      ...
      <a
        ...
        <div id="container" role="main">
          <div id="roadmap" className="page p-roadmap hidden">
                ...
                <section className="p-roadmap__timeline">
                  <div className="robot">
                    <div className="robot-desktop">
                      ...
                      >
                        <source
                          data-src="https://shiplay.io/library/videos/chirpley-roadmap-robot.mp4"
                          type="video/mp4"
                        />
                      </video>
                  ...
                  <ul className="list">
                    <li className="item">
                      ...
                      <div className="wrapper">
                        <h2 className="title">Q1 2022</h2>
                        <p className="text">
                          ☑ Smart Contract Deployment
                          <br />
                          ☑ Partnerships with Game developers
                          <br />
                          ☑ Anti-Dump Security Measures
                          <br />
                          ☑ Release Whitepaper
                          <br />
                          ☑ NFT Preview
                          <br />
                          ☑ Lunch Demo of the GAMEPLAY
                          <br />
                          ☑ Web3 Integration
                          <br />
                          ☑ Establish Mod &amp; Admins Team
                          <br />
                          ☑ Build out Social Medias
                          <br />
                          ☑ Build Social media management team
                          <br />
                          ☑ Presale and launch date announced
                          <br />
                          ☑ Marketing push to spread awareness
                          <br />
                          ☑ Whitelist Contest for Presale
                          <br />
                          ☑ MULTIPLAYER Integration in-game
                          <br />
                          ☐ $SPLY Presale
                          <br />
                          ☐ Chat Integration in-game
                          <br />
                          ...
                          <br />☐ The release version of the game
                        </p>
                      </div>
                    </li>
                    <li className="item">
                      <div className="bg" />
                      <div className="wrapper">
                        <h2 className="title">Q2 2022</h2>
                        <p className="text">
                          ☐ Translation of the web to other languages
                          <br />
                          ☐ Gate.io Listing
                          <br />
                          ☐ Bitmart Listing
                    ...
                    <li className="item">
                      ...
                      <div className="wrapper">
                        ...
                        <p className="text">
                          ...
                          ☐ Team Expansion
                          <br />
                          ☐ Certik &amp; Dessert Finance Audit
                          <br />
                          ☐ Exchange Listing
                          <br />☐ Partnerships with VR / AR developers
                        </p>
                      </div>
                    </li>
                    <li className="item">
                      <div className="bg" />
                      <div className="wrapper">
                        <h2 className="title">Q4 2022</h2>
                        <p className="text">
                          ☐ PartnerShip with NXISE.COM company marketplace{" "}
                          <br />
                          .....
                        </p>
                      </div>
