    ...
    <div>
      <div>
        ...
        <div id="container" role="main">
          <div id="flowchart" className="page p-flowchart hidden">
            ...
            <div className="js-scroll">
              <main className="page-wrapper">
                <section className="p-flowchart__header">
                  ...
                  <div className="content">
                    <h2 className="subtitle">
                      ShiPlay <b>FOR</b> GAMERS
                    </h2>
                    <div className="text">
                      <p className="p1">
                        All holders of a $SPLY TOKEN. They win daily prizes from
                        the daily coin fees and are evaluated in a fair manner.
                      </p>
                      <p className="p1">
                ...
                <section className="p-flowchart__diagram">
                  <div className="abs bg" />
                  <div className="diagram">
                    <div className="diagram-desktop">
                      <img
                        className="lazy"
                        data-src="https://shiplay.io/library/svg/desktop-diagram.png"
                        alt="Diagram"
                      />
                    </div>
