...
<a
        ...
        <div id="container" role="main">
          <div id="token" className="page p-token hidden">
                ...
                <section className="p-token__numbers">
                  <div className="graphics">
                    <div className="wrapper">
                      <div className="t-center abs bird">
                        <picture
                          className="r "
                          style={{ paddingBottom: "78.947368421053%" }}
                          data-ratio="0.78947368421053"
                        >
                          <img
                            className="lazy"
                            src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                            data-src="https://shiplay.io/library/media/token-bird.png"
                            data-srcset="https://shiplay.io/library/media/token-bird.png 320w, https://shiplay.io/library/media/token-bird.png 608w"
                            data-sizes="(min-width: 750px) 30vw, 90vw"
                            alt="Bird"
                          />
                        </picture>
                      </div>
                      <img
                        className="graphic"
                        src="https://shiplay.io/library/svg/token-graphics.png"
                        alt=""
                      />
                    </div>
                  </div>
                  <ul className="list">
                    <li className="item">
                      ...
                      <div className="item-percent">45%</div>
                      <div className="item-number">450 000 000 000</div>
                    </li>
                    <li className="item">
                      <div className="item-title">Play To Earn</div>
                      <div className="item-percent">15%</div>
                      <div className="item-number">150 000 000 000</div>
                    </li>
                    <li className="item">
                      <div className="item-title">Staking</div>
                      <div className="item-percent">15%</div>
                      <div className="item-number">150 000 000 000</div>
                    </li>
                    <li className="item">
                      <div className="item-title">Development</div>
                      <div className="item-percent">15%</div>
                      <div className="item-number">150 000 000 000</div>
                    </li>
                    <li className="item">
                      <div className="item-title">Marketing</div>
                      <div className="item-percent">5%</div>
                      <div className="item-number">50 000 000 000</div>
                    </li>
                    <li className="item">
                    ...
                    <li className="item">
                      ...
                      <div className="item-number">1 000 000 000 000</div>
                    </li>
                  </ul>
                </section>
                <section className="p-token__discount">
                  <div className="discount-header">
                    <div className="token" data-prllx="1.1" data-p-no-mask>
                      <video
                      ...
                      >
                        <source
                          data-src="https://shiplay.io/library/videos/chirpley-token-yellow.mp4"
                          type="video/mp4"
                        />
                      </video>
                    </div>
                    <h2 className="title">
                      ShiPlay Token
                      <br /> Mint NFTS and get your reward every DAY
                    </h2>
                  </div>
                  <div className="discount-content">
                    <div className="card card-robot">
                      ...
                      <div
                        ...
                        data-p-no-mask
                      >
                        <div className="t-center robot">
                          <picture
                            className="r "
                            style={{ paddingBottom: "127.09497206704%" }}
                            data-ratio="1.2709497206704"
                          >
                            <img
                              className="lazy"
                              src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                              data-src="https://shiplay.io/library/media/robot.png"
                              data-srcset="https://shiplay.io/library/media/robot.png 320w, https://shiplay.io/library/media/robot.png 640w, https://shiplay.io/library/media/robot.png 1024w, https://shiplay.io/library/media/robot.png 1074w"
                              data-sizes="40vw"
                              alt="Robot"
                            />
                          </picture>
                    ...
                    <div className="card card-text">
                      ...
                      <div className="card-wrapper">
                        <h3 className="title">
                          Our fees 9%, <b>for</b> GAMERS
                        </h3>
                        <div className="text">
                          <p>5% AirDrop in-game Rewards </p>
                          <p>
                            --&gt; To keep our community entertained and
                            rewarded,
                            <br /> 5% of every transaction will go to the
                            in-game Rewards.
                          </p>
                          <p>2% LIQUIDITY</p>
                          <p>
                            --&gt; 2% of every transaction goes to our locked
                            liquidity pool SPLY/BNB in PancakeSwap, creating an
                            ever-rising price floor.
                          </p>
                          <p>2% Development and Platform</p>
                          <p>
                            --&gt; After every buy/sell 2% will be going to
                            platform buildings.
                          </p>
                        </div>
                      </div>
